...
public class MailBodyHtml {
    ...
    public String verifyAccountContent(String verificationCode, String title, String buttonString) {
        String verificationUrl = shopClientUrl + "/mail/verify?code=" + verificationCode;
        return "<div style=\"font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px; background-color: #f9f9f9;\">"
                ...
                + "<p style=\"font-size: 12px; color: #777;\">&copy; 2024 Your Company Name. All rights reserved.<br>"
